...
public class LoginActivityTest extends LoginUtility{
         ...
         */
        public LoginActivityTest(Type type, String usernameInput, String passwordInput){
            this.type = type;
        ...
        public static Collection<Object[]> data(){
            return Arrays.asList(new Object[][] {
                    {Type.sampleLogin, LoginUtility.testLoginUserSample, testLoginUserSamplePass},
                    {Type.invalidLOGIN, LoginUtility.testLoginUserInvalid, testLoginUserInvalidPass},
                    {Type.validLOGIN, LoginUtility.validLoginUser, LoginUtility.validLoginPass}
            });
        }
